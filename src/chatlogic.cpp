...
ChatLogic::ChatLogic()
{
    //// STUDENT CODE
    ////
    std::cout << "Something from ChatLogic() constructor...line 19 chatlogic.cpp" << std::endl;
...
ChatLogic::~ChatLogic()
{
    //// STUDENT CODE
    ////
    std::cout << "Something fromg ~ChatLogic() destructor...line 34 chatlogic.cpp" << std::endl;
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        std::cout << "Something from LoadAnswerGraphFile if == \"NODE\"...from line 130 in chatlogic.cpp" << std::endl;
                    ...
                    if (type->second == "EDGE")
                    {
                        //// STUDENT CODE
                        ////
                        std::cout << "Something from LoadAnswerGraphFile if == \"EDGE\"...from line 154 in chatlogic.cpp" << std::endl;
    ...
    //// STUDENT CODE
    ////
    std::cout << "Still something more from LoadGraphFromAnswerFile...line 201 chatlogic.cpp" << std::endl;
    // identify root node

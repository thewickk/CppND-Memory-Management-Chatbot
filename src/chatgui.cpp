    ...
    : wxScrolledWindow(parent, id)
{
    ...
    std::cout << "new ChatLogic instance created in line 121 from chatgui.cpp" << std::endl;
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    std::cout << "_chatLogice instance being destroyed, line 140 chatgui.cpp" << std::endl;
    delete _chatLogic;
